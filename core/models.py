...
class Category(models.Model):
    cid = ShortUUIDField(unique=True, length=10, prefix="cat")
    title = models.CharField(max_length=255, default="Food")
...
class Vendor(models.Model):
    vid = ShortUUIDField(unique=True, length=10, prefix="ven")
...
class Product(models.Model):
    pid = ShortUUIDField(unique=True, length=10, prefix="prd")
...
class CartOrder(models.Model):
    ...
    sku = ShortUUIDField(null=True, blank=True, length=5, prefix="SKU", max_length=20)
    oid = ShortUUIDField(null=True, blank=True, length=5, prefix="SKU", max_length=20)
