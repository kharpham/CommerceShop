    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=10, max_length=13, prefix='cat', unique=True)),
                ('title', models.CharField(default='Food', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=10, max_length=13, prefix='prd', unique=True)),
                ('title', models.CharField(default='New product', max_length=255)),
                ...
                ('old_price', models.DecimalField(decimal_places=2, default='2.99', max_digits=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=10, max_length=13, prefix='ven', unique=True)),
                ('title', models.CharField(default='New vendor', max_length=255)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is the new vendor', null=True)),
                ('address', models.CharField(default='123 Main Street.', max_length=255)),
                ('contact', models.CharField(default='+123 (456) 789', max_length=255)),
